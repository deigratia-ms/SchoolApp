...
urlpatterns = [
    ...
    path('export-users/<str:format_type>/', views.export_users, name='export_users'),
    path('teacher-management/', views.teacher_management, name='teacher_management'),
    path('export-teachers/<str:format_type>/', views.export_teachers, name='export_teachers'),
    ...
    path('export-students/<str:format_type>/', views.export_students, name='export_students'),
    path('parent-management/', views.parent_management, name='parent_management'),
    path('export-parents/<str:format_type>/', views.export_parents, name='export_parents'),
    path('staff-management/', views.staff_management, name='staff_management'),
    path('export-staff/<str:format_type>/', views.export_staff, name='export_staff'),
    ...
    path('receptionist/enquiries/', receptionist_views.receptionist_enquiries, name='receptionist_enquiries'),
